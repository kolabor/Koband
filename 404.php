...
get_header();
	...
	<html>
	<head>
		<title><?php __('Temporarliy Unavailable', 'koband');?></title>
	</head>
	<body>
		<div id="wrapper">
			<center>
				<!-- This is the generic database error page that will be shown when a fatal db connection issue aries -->
				<h1><?php echo $_SERVER['HTTP_HOST'];?><?php __('is Temporarliy Unavailable', 'koband');?></h1>
				<p><?php __('The webmaster has been alerted. Please try again later.', 'koband');?></p>
			</center>
		</div>
	</body>
	</html>
