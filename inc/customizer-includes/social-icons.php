...
class Customizer_Typo_Control_Typography extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			array(
				'family'      => esc_html__( 'Font Family', 'koband' ),
				'size'        => esc_html__( 'Font Size',   'koband' ),
				'weight'      => esc_html__( 'Font Weight', 'koband' ),
				'style'       => esc_html__( 'Font Style',  'koband' ),
				'line_height' => esc_html__( 'Line Height', 'koband' ),
			)
		);
	}
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'koband-customize-controls' );
		wp_enqueue_style(  'koband-customize-controls' );
	}
	/**
