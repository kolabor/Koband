...
<div class="container search-holder">
	...
	<div class="row author-rows koband_post_news">
		...
		if ($author_posts->have_posts() ) : ?>
        	...
        	<?php endwhile; ?>
		<?php endif; ?>
	</div><!--row author-rows koband_post_news -->
	<div class="row author-rows koband_post_media">
		...
		if ($author_media->have_posts() ) : ?>
	 	...
	 	<!-- start loop --> 
		<?php while ( $author_media->have_posts() ) : $author_media->the_post();
		$post_id = get_the_ID(); ?>
	...
	<div class="row author-rows">
		...
		if ($author_single_posts->have_posts() ) : ?>
			<header class="author-header"> <?php
			$curauth = (isset($_GET['author_name'])) ? get_user_by('slug', $author_name) : get_userdata(intval($author));?>
	...
	<div class="row author-rows">	
	    ...
	    <div class="divTable">
            <div class="divTableBody koband_post_tour">
                ...
                <?php while ( $author_tour_posts->have_posts() ) : $author_tour_posts->the_post(); 
        		    $post_id = get_the_ID();  
