...
<div class="container tag_page search-holder">
	    ...
	    <header class="archive-header">
		<h1 class="archive-title"><?php printf( esc_html__( 'Tag Tour Archives: %s', 'koband' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?>
		</h1>
			<?php if ( tag_description() ) : // Show an optional tag description ?>
				<div class="archive-meta"><?php echo esc_html(tag_description()); ?></div>
			<?php endif; ?>
	...
	<div class="row author-rows">
		...
		$tags_album_posts = new WP_Query($args_tags_album); ?>
	   	<?php if ($tags_album_posts->have_posts() ) : ?>
	   		<header class="archive-header">
		<h1 class="archive-title"><?php printf( esc_html__( 'Tag Album Archives: %s', 'koband' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?>
		</h1>
			<?php if ( tag_description() ) : // Show an optional tag description ?>
				<div class="archive-meta"><?php echo esc_html(tag_description()); ?></div>
			<?php endif; ?>
			...
			<div class="row album-head border_first_color main_font_color">
				...
				<div class="container album-songs-show-hide">
					...
					<?php foreach ($album_song_details[0] as  $value_song_details) { ?>
						...
						<div class="col-sm-4"><?php if(isset($value_song_details['detail'])) {echo esc($value_song_details['detail']);} ?></div>
	...
	<div class="row author-rows">
		...
		<?php if ($tags_single_posts->have_posts() ) : ?>
			<header class="archive-header">
		<h1 class="archive-title"><?php printf( esc_html__( 'Tag Single Archives: %s', 'koband' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?>
		</h1>
			<?php if ( tag_description() ) : // Show an optional tag description ?>
				<div class="archive-meta"><?php echo esc_html(tag_description()); ?></div>
			<?php endif; ?>
			...
			<div class="container">
				<div class="row album-head border_first_color">
					<div class="col-sm-1"><a href="<?php the_permalink();?>" target="_blank" ><?php the_post_thumbnail(array(70,70));?></a></div>
						<div class="col-sm-3 main_font_color"><?php esc_html__('Name:', 'koband');?><br><a href="<?php the_permalink();?>" target="_blank" ><span class="main_font_color"><?php the_title();?></span></a></div>
						<div class="col-sm-3 main_font_color"><?php esc_html__('Date:', 'koband');?><br><span class="main_font_color"><?php if(isset($single_date[0])) 	{ echo  esc_attr($single_date[0]); } ?></span></div>
						<div class="col-sm-3 main_font_color"><?php esc_html__('Length:', 'koband');?><br><span class="main_font_color"><?php if(isset($single_length[0])) 	{ echo  esc_attr($single_length[0]); } ?></span></div>
	...
	<div class="row author-rows">
	    ...
	    if ($tags_media_posts->have_posts() ) : ?>
	 	<!-- start loop -->
	 	<header class="archive-header">
		<h1 class="archive-title"><?php printf( esc_html__( 'Tag Media Archives: %s', 'koband' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?>
		</h1>
			<?php if ( tag_description() ) : // Show an optional tag description ?>
				<div class="archive-meta"><?php echo esc_html(tag_description()); ?></div>
			<?php endif; ?>
