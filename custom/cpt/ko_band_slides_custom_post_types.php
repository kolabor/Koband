...
function ko_band_slides_meta_box($post, $box){
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm"><input type="text" name="ko_band_slides_title" value="<?php echo esc_textarea( $slides_title )?>" placeholder= "<?php _e('Slide Title', 'koband');?>" class="slidetitle"></div>
            <div class="col-sm"><input type="text" name="ko_band_slides_subtitle" value="<?php echo esc_textarea( $slides_subtitle )?>" placeholder= "<?php _e('Slide text', 'koband');?>" class="slidesub"></div>
        </div>
        ...
        <div class="row">        
            ...
            <div class="col-sm"><input type="text" name="ko_band_slides_button_link" value="<?php echo esc_textarea( $slides_button_link )?>" placeholder="<?php _e('Link', 'koband');?>" class="slidebuttonlink"></div>
        </div>
    </div>
