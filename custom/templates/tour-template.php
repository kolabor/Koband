...
<div id="Tour" class="section">
    ...
    <?php endif;?>
        ...
        <div class="container text-center">
            <div class="row">
                <a class="btn-koband-load koband_load_tour border_color main_font" data-page="1" data-url="<?php echo esc_attr(admin_url('admin-ajax.php')); ?>">
                    <span class="koband-loading main_font"><?php echo esc_html__('Loading...','koband');?></span>
                    <span class="text main_font"><?php echo esc_html__('Load tour','koband');?></span></a>
                <a class="no-tour"><span class="tour-posts main_font"><?php echo esc_html__('There are no more tours', 'koband');?>   <i class="far fa-smile"></i></span></a>
            </div>
        </div><!--container-->
    </div><!--container-->
</div>