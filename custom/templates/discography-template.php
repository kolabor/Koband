	...
	<div class="container">
		<div class="row album-head border_first_color main_font_color">
			<div class="col-sm-1"><a href="<?php the_permalink();?>" target="_blank" ><?php the_post_thumbnail(array(70,70));?></a></div>
				<div class="col-sm-3 album_title main_font_color"><?php echo __('Album Name:<br>', 'koband');?><a href="<?php the_permalink();?>" target="_blank" >    <span class="main_font_color"><?php the_title();?></span></a></div>
			...
			<div class="container album-songs-show-hide">
				...
				<?php foreach ($album_song_details[0] as  $value_song_details) { ?>
					<div class="col-sm-4 song_info border_bottom line"><?php if(isset($value_song_details['name-details'])) {echo $value_song_details['name-details'];}?></div>
					<div class="col-sm-4 song_info border_bottom line"><?php if(isset($value_song_details['length'])) {echo $value_song_details['length'];} ?></div>
					<div class="col-sm-4 song_info border_bottom "><?php if(isset($value_song_details['detail'])) {echo $value_song_details['detail'];} ?></div>
				...
				<div class="row album-store border_first_color main_font_color">
					...
					<?php 
						...
						<div class="col-sm-3 store_link btn-buy line"><a class="bg_first_color" href="<?php if(isset($value_song_store['link'])) {echo $value_song_store['link'];}?>"><i class="fas fa-shopping-cart"></i><?php echo __('Buy Here', 'koband');?></a></div> </div>
...
-->
	...
	<div class="container">
		<div class="row album-head border_first_color">
			<div class="col-sm-1"><a href="<?php the_permalink();?>" target="_blank"><?php the_post_thumbnail(array(70,70));?></a></div>
				<div class="col-sm-3 album_title main_font_color"><?php echo __('Name:<br>', 'koband');?><a href="<?php the_permalink();?>" target="_blank"><span class="main_font_color"><?php the_title();?></span></a></div>
	...
	<div class="container single-songs-show-hide">
		...
		<div class="row album-head border_first_color main_font_color">
			<div class="col-sm-5 store"><?php echo __('Store Name:', 'koband');?></div>
			<div class="col-sm-5 store"><?php echo __('Store Link:', 'koband');?></div>
		</div>
		<div class="row song-list border_second_color main_font_color">
