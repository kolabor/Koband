			...
			<div class="container">
				...
				<div class="container text-center">
					<div class="row ">
						...
						<div class="btn-koband-load koband_load_more border_color main_font" data-page="1" data-url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>">
							<span class="koband-loading main_font first_color"><?php echo esc_html__('Loading...', 'koband');?></span>
							<span class="text main_font first_color"><?php echo esc_html__('Load more', 'koband');?></span></div>
