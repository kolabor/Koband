					    ...
					    <?php	$url = wp_get_attachment_url( get_post_thumbnail_id() );?>
					    	<img src="<?php echo esc_url($url); ?>" alt="<?php the_title(); ?>">
					            <div class="sl-content">
								    <h5 class="slider_text_color"><?php if(isset($slider_title[0])) 	{ echo esc_attr($slider_title[0]); } ?></h5>
								    <p class="slider_text_color font-line_height"><?php if(isset($slider_subtitle[0])) 	{ echo esc_attr($slider_subtitle[0]); } ?></p>
								    <a class="btn btn-lg slider_button_text_color" href="<?php if(isset($slider_button_link[0])) 	
