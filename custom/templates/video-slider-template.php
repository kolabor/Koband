...
<?php 
	...
	while( have_posts() ) : the_post();
		...
		$test_loop = $slide_video_link . '?rel=0&autoplay=1&loop=1&mute=1&playlist=' . $playlist_loop ;
		str_replace(array("http://"), "", $test_loop);?>

	<?php endwhile; ?>
	<!--loop ends here-->
		<div class="video-bg">
				<div class="iframe-wrapper">
					<iframe  src="<?php echo esc_url($test_loop)?>" ></iframe>
				</div>		
		</div>		
