...
function ko_band_music_meta_box($post, $box){
    ...
    wp_nonce_field( plugin_basename( __FILE__ ), 'music_fields' );
    ...
    echo "<p>  Sinlge Cover: </p>";
    echo '<input type="link" name="ko_band_single_cover" value="' . esc_html( $single_cover )  . '" class="widefat" placeholder="Single Cover">';    
...
function ko_band_music_save_meta_box( $post_id, $post ) {
    ...
    wp_verify_nonce(plugin_basename(__FILE__), 'music_fields' );
