        ...
        <div class="col-sm-12">
            <div class="container single-tour-container-holder">
                ...
                <div class="row tour_single_page_row">
                    ...
                    <div class="col-sm-6 main_font_color album-info store_link btn-buy border_first_color "><?php if(isset($tour_ticketlink[0])) {?> <a class="bg_first_color" href="<?php echo esc_url($tour_ticketlink[0]);?>"><i class="fas fa-shopping-cart"></i><?php echo esc_html__('Buy Here', 'koband');?></a><?php } ?></div>
                </div>
            </div><!-- container -->
        </div><!-- col-sm-8 -->
    </div><!-- row -->      
